...
const LawyerMyCases = ({ onMessageProvider }) => {
    ...
    const downloadDocument = async (url, filename = "document") => {
        try {
            ...
            // Try to guess extension from blob type if possible, or default to pdf if unknown
                        ...
                        <div key={c.id} className="group bg-[#1a1a1a] rounded-2xl border border-[#222] hover:border-[#D4AF37]/50 transition-all duration-300 flex flex-col h-full hover:shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                            ...
                            <div className="p-6 pb-4 border-b border-[#222] group-hover:border-[#333] transition-colors">
                                ...
                                <div className="flex items-center gap-4 text-xs text-gray-500 mt-3">
                                    ...
                                    <span className="flex items-center gap-1.5">
                                        <FiActivity className="text-[#D4AF37]" /> {c.urgency || "Standard"} Priority
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="p-6 flex-1 space-y-4">
                                ...
                                <div className="flex items-start gap-4 p-3 rounded-xl bg-[#111] border border-[#222]">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-0.5">Applicant</p>
                                        <p className="text-sm font-bold text-gray-200">{c.applicantName || "Protected Identity"}</p>
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-2">
                                    <div className="space-y-1">
                                        <p className="text-[10px] text-gray-600 uppercase font-black tracking-wider">Classification</p>
                                        <p className="text-xs text-gray-300 font-medium truncate">{c.caseType || "N/A"}</p>
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[10px] text-gray-600 uppercase font-black tracking-wider">Jurisdiction</p>
                                        <p className="text-xs text-gray-300 font-medium truncate">{c.courtType || "District Court"}</p>
                                    </div>
                    ...
                    <div className="bg-[#1a1a1a] border border-[#333] w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl shadow-2xl" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="p-8 space-y-8">
                            <div className="grid grid-cols-2 gap-8">
                                ...
                                <div>
                                    <h4 className="text-gray-500 text-xs font-bold uppercase tracking-wider mb-2">Applicant</h4>
                                    <p className="text-white font-medium">{selectedCase.applicantName}</p>
                                    <p className="text-gray-500 text-sm">{selectedCase.email}</p>
                                </div>
                                <div>
                                    <h4 className="text-gray-500 text-xs font-bold uppercase tracking-wider mb-2">Date Filed</h4>
                                    <p className="text-white font-medium">{formatDate(selectedCase.createdAt)}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <h4 className="text-gray-500 text-xs font-bold uppercase tracking-wider mb-2">Jurisdiction</h4>
                                    <p className="text-white">{selectedCase.courtType}</p>
                                </div>
                                <div>
